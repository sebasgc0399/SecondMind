  ...
  translation: {
    admin: {
      members: {
        ...
        revokeError: 'No se pudo revocar el acceso. Probá de nuevo.';
        searchAria: 'Buscar miembros por email';
      };
      requests: {
        approve: 'Aprobar';
        empty: 'No hay solicitudes pendientes.';
        errorFull: 'Beta llena ({{max}}). Subí el límite o revocá un miembro antes de aprobar.';
        errorFullNoMax: 'Beta llena. Subí el límite o revocá un miembro antes de aprobar.';
        errorGeneric: 'No se pudo procesar la solicitud. Probá de nuevo.';
    ...
    auth: {
      accessRequest: {
        ...
        errorEmail: 'Revisá el email ingresado.';
        errorGeneric: 'No se pudo enviar la solicitud. Probá de nuevo.';
        errorRateLimit: 'Demasiados intentos. Probá de nuevo más tarde.';
