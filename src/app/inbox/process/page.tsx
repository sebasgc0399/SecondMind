...
export default function InboxProcessorPage() {
  ...
  useEffect(() => {
    ...
    if (items.length > 0) {
      // eslint-disable-next-line react-hooks/set-state-in-effect -- snapshot one-shot tras HYDRATION_GRACE_MS; ref guard `batch !== null` previene loop. Patrón canónico para freezing async data al primer render con valor
