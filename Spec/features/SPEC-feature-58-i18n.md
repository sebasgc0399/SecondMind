...
> **Estado:** F1 **COMPLETADA** y mergeada (2026-06-11, Done E2E 9/9). F2.1 (layout + navegación) **COMPLETADA** y mergeada (2026-06-12: ~50 keys, gate verde, smoke vs baseline GO, excepción (d) aprobada por Sebastián; protocolo instrument actualizado a detector-only — ver § F2). Pre-requisitos deps-1/deps-2 incluidos en el mismo arco. **Siguiente: F2.2** (dashboard + habits). GO original de Sebastián: 2026-06-10.
