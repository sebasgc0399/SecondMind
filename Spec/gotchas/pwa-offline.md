...
## Android — el HTTP cache del WebView sirve el bundle viejo tras update de APK (F61)
...
- **QA on-device:** en debug `versionCode=1` salvo `assembleDebug -PversionCode=N` → simular bumps con esa prop (Casos A–D en SPEC-61).
